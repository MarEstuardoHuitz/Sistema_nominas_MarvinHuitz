  <!--En esta pagina se agregan las comisiones al empleado -->
  ...
  <q-page padding>
    ...
    >
      <div class="row">
        ...
        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-select rounded outlined v-model="modelEmpleado" :options="optionsEmpleado" label="Seleccione Empleado" filled @update:model-value="val =>{getComisionEmpleado(val)}"/>
        </div>

        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-input rounded outlined v-model="venta" type="number" label="Ingrese Total de Ventas" />
        </div>
