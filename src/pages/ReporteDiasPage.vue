  ...
  <q-page padding>
    ...
    >
      <div class="row">
        ...
        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-select rounded outlined v-model="modelEmpleado" :options="optionsEmpleado" label="Seleccione Empleado" filled @update:model-value="val =>{getReporteEmpleado(val)}"/>
        </div>

        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-input rounded outlined v-model="dias" type="number" label="Ingrese Total de Dias a Reportar"
