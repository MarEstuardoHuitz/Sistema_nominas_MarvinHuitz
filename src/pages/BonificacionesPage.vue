  <!-- Esta pagina contiene todas bonifiaciones que se le pueden hacer al empleado -->
  ...
  <q-page padding>
    ...
    >
      <div class="row">
        ...
        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-select rounded outlined v-model="modelEmpleado" :options="optionsEmpleado" label="Seleccione Empleado" filled @update:model-value="val =>{getBonificacionEmpleado(val)}"/>
        </div>

        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-input rounded outlined v-model="piezas" type="number" label="Ingrese Total de Piezas Elaboradas" />
        </div>
