    ...
    >
      <div class="row">
        ...
        <div class="col-xs-4 col-md-3 q-pr-md">
          <q-input rounded outlined v-model="nombre" type="text" label="Nombre"
        ...
        <div class="col-xs-4 col-md-3 q-pr-md">
          <q-input rounded outlined v-model="apellido" type="text" label="Apellido"
         ...
         <div class="col-xs-3 col-md-3 q-pr-md">
          <q-input rounded outlined v-model="telefono" type="text" label="Telefono"
          ...
          />
           ...
           <div class="col-xs-3 col-md-3 q-pr-md">
          <q-input rounded outlined v-model="direccion" type="text" label="Direccion"
          ...
          />
           ...
           <div class="col-xs-3 col-md-3 q-pr-md">
          <q-input rounded outlined v-model="dpi" type="text" label="DPI"
          ...
          />
           ...
           <div class="col-xs-3 col-md-3 q-pr-md">
          <q-input rounded outlined v-model="igss" type="text" label="Afiliacion IGGS"
            :rules="[ val => val != null || 'Debe ingresar un Valor' ]"
          />
        </div>

        <div class="col-xs-4 col-sm-2 col-md-2 q-pr-md">
          <q-toggle rounded outlined v-model="estado" color="green" label="Estado" left-label />
        </div>

        <div class="col-xs-4 col-sm-2 col-md-2 q-pr-md" >
            <q-input rounded outlined v-model="fechaNac" filled type="date" label="Fecha Nacimiento"
              :rules="[ val => val != null || 'Debe ingresar un Valor' ]"
            />
        </div>

        <div class="col-xs-4 col-sm-2 col-md-2 q-pr-md">
            <q-input rounded outlined v-model="fechaInicio" filled type="date" label="Fecha Contratacion"
              :rules="[ val => val != null || 'Debe ingresar un Valor' ]"
            />
        </div>

        <div class="col-xs-4 col-sm-2 col-md-2 q-pr-md">
            <q-input rounded outlined v-model="fechaFin" filled type="date" label="Fecha de Despido"
            />
        </div>

        <q-select class="col-xs-12 col-sm-2 q-pr-md"
          rounded outlined v-model="estadoCivil"
          :options="estadosCiviles" label="Estado Civil" filled
          :rules="[ val => val != null || 'Debe ingresar un Valor' ]"
        />


        <q-input class="q-pr-md" rounded outlined v-model="Sueldo" type="number" label="Sueldo"
          :rules="[
            val => parseFloat(val) >= 0 || 'Debe Ingresar un valor mayor a cero'
          ]"
        />

        <q-select
        class="col-xs-12 col-sm-2 q-pr-md"
        rounded outlined v-model="departamento"
        ...
        <q-select
        class="col-xs-12 col-sm-2 q-pr-md"
        rounded outlined v-model="puesto"
        :options="puestos"
        label="Puesto"
        filled
        use-input
        ...
        <q-file v-if="codigo" color="teal" rounded outlined v-model="photoModel" label="Subir Foto" accept=".jpg, .jpeg, .png, .bmp, .webp">
...
export default defineComponent({
  ...
  setup(){
    ...
    const pass=ref('');
    const estadosCiviles=ref(['Soltero','Casado','Divorciado']);
