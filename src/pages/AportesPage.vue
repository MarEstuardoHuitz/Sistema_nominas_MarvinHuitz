  <!-- En esta Pagina se encentra los aportes que hace el empleado -->
  <!-- <div class="row"> -->
  ...
  <q-page padding>
    ...
    >
      <div class="row">
        ...
        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-select rounded outlined v-model="modelEmpleado" :options="optionsEmpleado" label="Seleccione Empleado" filled @update:model-value="val =>{getaporteEmpleado(val)}"/>
        </div>

        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-input rounded outlined v-model="aporte" type="number" label="Ingrese Total de Aporte"
