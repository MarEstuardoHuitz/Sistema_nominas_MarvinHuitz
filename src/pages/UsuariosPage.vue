    ...
    >
      ...
      <!-- <div class="row"> -->
        ...
        <div class="col-xs-8 col-sm-10 col-md-3 q-pa-sm">
          <q-input  rounded outlined v-model="pass" type="text" label="Contraseña"
            counter
      ...
      <!-- </div> -->
      <!-- <div class="row"> -->
        <q-select class="col-xs-12 col-sm-2 q-pa-sm" rounded outlined v-model="rol" :options="roles" label="Rol / Permiso" filled />

        <q-input class="q-pa-xs col-sm-4 q-pa-sm" rounded outlined v-model="email" type="email" label="Email"
          counter
        />
      </div>
      <div>
      ...
      >
        <template v-slot:top-right>
          <q-input
            ...
            borderless dense v-model="filter" placeholder="Usuarios del Sistema" clearable>
            <template v-slot:append>
              <q-icon name="search" />
            </template>
          </q-input>
...
<script lang="ts">
import { exportFile, QSpinnerFacebook, QTableProps, useQuasar } from 'quasar';
