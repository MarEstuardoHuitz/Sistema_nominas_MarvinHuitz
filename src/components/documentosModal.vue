          ...
          <div class="row q-ma-sm">
            ...
            <div class="row q-pt-lg q-pb-lg">
                ...
                <div class="col q-pa-sm col-md-3">
                    <q-select class="col-xs-12 col-sm-2 q-pr-md" rounded outlined v-model="tipoDoc" :options="tiposDoc" label="Tipo Documento" filled />
                </div>
                ...
                <div class="col q-pa-sm col-md-3">
                    ...
                    color="teal"
                    filled
                    rounded outlined v-model="docModel"
